...
#define MyAppName "KrankyBearProcessMiner"
#define MyAppVersion "0.4.0"
#define MyAppPublisher "Allan Marillier, 2025-"
#define MyAppURL "https://github.com/amarillier/KrankyBearProcessMiner"
#define MyAppExeName "KrankyBearProcessMiner.exe"
...
AppId={{51914B89-E9A5-41E6-BFB7-24C55BEFEECA}
AppName={#MyAppName}
...
OutputBaseFilename=KrankyBearProcessMinerSetup_{#MyAppVersion}
SetupIconFile=..\assets\images\KrankyBearProcessMiner.ico
Compression=lzma
...
; not {app}\assets\mesa-win — duplicating the Mesa DLLs into both places would
; be wasteful, and the runtime fallback (internal/startup/
...
; KrankyBearProcessMiner.exe only moves these into {app} directly if a
; hardware OpenGL probe fails first; see internal/startup/mesa_fallback_windows.go.
...
; KrankyBearProcessMiner.exe moves these two out of mesa-fallback into {app}
